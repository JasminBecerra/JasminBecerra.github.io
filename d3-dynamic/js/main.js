...
function setMap(){
    ...
    d3.queue()
        .defer(d3.csv, "d3-dynamic/data/ChicagoSocioEconData3.csv") //load attributes from csv
        .defer(d3.json, "d3-dynamic/data/illinCounties3.topojson") //load bacground data (illinois counties)
        .defer(d3.json, "d3-dynamic/data/ChicagoCommunities.topojson") //load spatial data for choropleth map
...
function setEnumerationUnits(chicagoCommunities, actualmap, path, colorScale){
        ...
        var desc = communities.append("desc")
            .text('{"stroke": "#343f59", "stroke-width": "0.7px"}');
...
function choropleth(props, colorScale){
    ...
    if (typeof val == 'number' && !isNaN(val)){
        ...
        return "#000"; //if there is no data for something, it'll appear black
    };
};
...
// svg for bar chart
    ...
    var bars = chart.selectAll(".bar")
        ...
        //     return 580 - yScale(parseFloat(d[expressed]));
        // })
        // .attr("y", function(d, i){
